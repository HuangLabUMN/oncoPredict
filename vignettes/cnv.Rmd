...
#Third, apply idwas() to test each cnv and each drug. The p-values and beta-values for each test will be returned as an object.
...
tryCatch({
  ...
  data<-as.data.frame(t(mapped_cnv$theCnvQuantVecList_mat))
  samps<-colnames(data)
